...
/***/ (function(module, exports, __webpack_require__) {
	...
	__vue_options__.__file = "C:\\project\\weex-frame\\src\\App.web.vue"
	__vue_options__.render = __vue_template__.render
	__vue_options__.staticRenderFns = __vue_template__.staticRenderFns
	__vue_options__._scopeId = "data-v-14a3e044"
	__vue_options__.style = __vue_options__.style || {}
	__vue_styles__.forEach(function (module) {
	  for (var name in module) {
	    __vue_options__.style[name] = module[name]
	...
	exports.default = {
	  created: function created() {
	    ...
	    this.$router.beforeEach(function (to, from, next) {
	      // 设置转场参数
	      _this.$Progress.parseMeta({
	        func: [{ call: 'color', modifier: 'temp', argument: '#00bf11' }, { call: 'fail', modifier: 'temp', argument: '#00bf11' }, { call: 'location', modifier: 'temp', argument: 'top' }, { call: 'transition', modifier: 'temp', argument: { speed: '1.0s', opacity: '0.2s' } }]
	      });
	      // 启动动画
